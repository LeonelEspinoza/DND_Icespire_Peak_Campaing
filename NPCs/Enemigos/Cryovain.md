...
>
>***Bite.*** *Melee Weapon Attack:* +7 to hit, reach 10 ft., one target. *Hit:* 15 (`dice: 2d10 + 4`) piercing damage plus 4 (`dice: 1d8`) cold damage.  
>
>***Claw.*** *Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 11 (`dice: 2d6 + 4`) slashing damage.  
>
>***Cold Breath (Recharge 5–6 ; `dice: 1d6`).*** The dragon exhales an icy blast in a 30-foot cone. Each creature in that area must make a DC 15 Constitution saving throw, taking 45 (`dice: 10d8`) cold damage on a failed save, or half as much damage on a successful one.
## Feats
...
Una [[Bastión Aguja de Hielo (Incompleta)|fortaleza derrumbándose]] en la punta noreste de Icespire Peak le sirve como guarida al dragón. Cryovain se apodero de la fortaleza helada perteneciente a una tribu de [[Orcos]] salvajes, matando al orco jefe de guerra y forzando a los supervivientes de la tribu a huir a los pies de la montaña y bosques.
